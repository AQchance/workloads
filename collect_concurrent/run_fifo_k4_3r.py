...
OUT_CSV     = '/home/anqian/Desktop/my_lab/workloads/collect_concurrent/fifo_k4_3r_trace.csv'
CKPT_FILE   = '/home/anqian/Desktop/my_lab/workloads/collect_concurrent/fifo_k4_3r_checkpoint.json'
...
def main():
    ...
    def worker(_):
        while not stop.is_set():
            ...
            with open('/home/anqian/Desktop/my_lab/workloads/collect_concurrent/fifo_k4_3r_trace.csv','a',newline='') as _tf:
                import csv as _csv
                _w=_csv.writer(_tf)
